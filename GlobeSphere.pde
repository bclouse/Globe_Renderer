class GlobeSphere {
  ...
  //Renders the image stored in the 'face' array onto the globe
  void renderImage() {
  ...
  /*==========================================================
       Rotates all of the coordinates according to the 
             'rotateAxis' and 'rotateAngle'
  ==========================================================*/
  ...
  /*==========================================================
       Resets the size of the globe and initializes 
